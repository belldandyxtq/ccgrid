...
performance computing \kento{Let us add citations of AWS, Microsoft Asure and
few others}.
...
SSD-embedded I/O subsystems and GPU accelerators
\kento{citation} .
...
buffers, we can accelerate the data intensive workloads \kento{citation for
applications having data access locality}.
