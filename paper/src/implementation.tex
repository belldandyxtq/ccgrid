...
optimized size ?'' ?} Files are divided into mutable-size \emph{chunks}, each
...
\kento{Q4: How do clients guarantee consistency between cached meta data \&
original meta data in the master node ? Please
send me an email to answer as Q4}
