...
file meta data, including the chunk placement information, \xtq{delete cache}then client caches
these information and connect to I/O nodes directly for sending or receiving data.
